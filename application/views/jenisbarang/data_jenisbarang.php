                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <a href="<?= base_url('jenisbarang/tambah'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($jenis_barang as $b) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('jenisbarang/edit/') . $b['id_jenis']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                    <a href="<?= base_url('jenisbarang/hapus/') . $b['id_jenis']; ?>" class="btn btn-sm btn-danger hapus"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>

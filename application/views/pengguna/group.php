...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Kelola Group</li>
        </ol>
    </section>
                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <a href="<?= base_url('auth/create_group'); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($groups as $g) : ?>
                                            <tr>
                                                ...
                                                <td><?= $g->description; ?></td>
                                                <td>
                                                    <a href="<?= base_url('auth/edit_group/') . $g->id; ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                    <a href="<?= base_url('auth/delete_group/') . $g->id; ?>" class="btn btn-sm btn-danger hapus"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
